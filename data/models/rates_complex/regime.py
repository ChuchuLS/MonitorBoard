"""
Continuous regime characterization for the rates within-complex basket.

Same machinery as cross_asset_ficc/regime.py — leader + 5-bit sign pattern.
Anchored on USGG10YR positive, so "+" in the 10Y position means "rates higher"
direction.
"""
...
# ---- Leader color palette (colorblind-safe, no red/green) -----------------
LEADER_COLOR = {
    "USGG10YR": "#3b82f6",  # blue
    "USYC2Y10": "#06b6d4",  # cyan (curve shape)
    "USGGBE10": "#f97316",  # orange (inflation expectations)
    "USGGT10Y": "#a855f7",  # purple (real)
    "MOVE": "#facc15",  # yellow (vol)
}

SPECIAL_COLOR = {
    "Mixed": "#525252",  # gray
    "Transitioning": "#e5e7eb",  # near-white
}
...
__REGIME_VERSION__ = "rates-v1.0-2026-05-09"
