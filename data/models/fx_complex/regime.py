"""
Continuous regime characterization for the FX within-complex basket.
...
EXP_VAR_THRESHOLD = 0.65  # 3 assets, mixed-units → slightly lower than credit
PERSISTENCE_THRESHOLD = 0.85


LEADER_COLOR = {
    "DXY": "#3b82f6",  # blue
    "FXJPEMCS": "#06b6d4",  # cyan (EM FX)
    "JYBSS12M": "#f97316",  # orange (funding stress signal stands out)
}
...
__REGIME_VERSION__ = "fx-v1.0-2026-05-09"
